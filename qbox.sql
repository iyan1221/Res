...
CREATE DATABASE IF NOT EXISTS `qbox` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `qbox`;
...
-- Dumping data for table qbox.bank_accounts_new: ~25 rows (approximately)
...
-- Dumping structure for table qbox.ox_inventory
...
-- Dumping data for table qbox.ox_inventory: ~0 rows (approximately)
...
-- Dumping structure for table qbox.player_jobs_activity
...
-- Dumping data for table qbox.player_jobs_activity: ~0 rows (approximately)
...
-- Dumping structure for table qbox.properties
...
-- Dumping data for table qbox.properties: ~0 rows (approximately)

-- Dumping structure for table qbox.properties_decorations
...
-- Dumping data for table qbox.properties_decorations: ~0 rows (approximately)

-- Dumping structure for table qbox.users
...
-- Dumping data for table qbox.users: ~0 rows (approximately)
...
-- Dumping structure for table qbox.xt_prison
...
-- Dumping data for table qbox.xt_prison: ~0 rows (approximately)

-- Dumping structure for table qbox.xt_prison_items
...
-- Dumping data for table qbox.xt_prison_items: ~0 rows (approximately)
