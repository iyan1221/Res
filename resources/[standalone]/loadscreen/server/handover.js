    ...
    const data = {
        ...
        config: {
            ...
            backgroundBrightness:
                GetConvarInt('loadscreen:backgroundBrightness', 50) / 100,
            ...
            serverMessage: GetConvar(
                ...
                '${playerName}, Selamat Datang ! Jangan Lupa Makan Minum Ya !  ${serverName}!',
            ),
            ...
            initialAudioVolume:
                GetConvarInt('loadscreen:initialAudioVolume', 0) / 100,

            music: GetConvarInt('loadscreen:music', 0 ) == 1,
            ...
            embedLink: GetConvar(
                ...
                'https://www.youtube.com/embed?playlist=psCsu6Umy_Y&autoplay=1&loop=1',
            ),
